...
@section('content')
    <div class="body1">
        ...
        <div class="collection-list typesource-list">
            <div class="collection-item">
                ...
                <div class="collection-item-content">
                    <div contenteditable="true" spellcheck="false">
                      ...
                      <a class="collection-overlay" href="/typesource/20-pursuit-of-purpose/">
                          <span href="/typesource/20-pursuit-of-purpose/" class="collection-overlay-button">View</span>
                      </a>
                </div>
                <div class="collection-item-details">
                    ...
                    <div class="collection-item-actions">
                        <a href="/typesource/20-pursuit-of-purpose/" class="collection-button collection-item-action">View</a>
                    </div>
                </div>
                <!--googleon: index-->
            </div>
            ...
            <div class="collection-item">
                <!--googleoff: index-->
                  <div class="collection-item-content">
                      <div contenteditable="true" spellcheck="false">
                          <div class="kir">
                            <h1 class="kir-r1">Fake</h1>
                            <h2 class="kir-r2">Keep it Real</h2>
                          </div>
                        ...
                        <a class="collection-overlay" href="/typesource/19-keep-it-real/">
                          <span href="/typesource/19-keep-it-real/" class="collection-overlay-button">View</span>
                        </a>
                  </div>
                  <div class="collection-item-details">
                      <span class="collection-item-text">
                      ...
                      <div class="collection-item-actions">
                        <a href="/typesource/19-keep-it-real/" class="collection-button collection-item-action">View</a>
                      </div>
                  </div>
                      <!--googleon: index-->
            </div>
                        ...
                        <div class="smt">
                            ...
                            <h1 class="smt-r2">Morning Times</h1>
                              ...
                              <style type="text/css">
                                  ...
                                  color: #fff;
                                  text-align: center;
                                  background-image: url(/img/saturday.jpg);
                                  background-size: cover;
                            ...
                            <a class="collection-overlay" href="/typesource/18-saturday-morning-times/">
                              <span href="/typesource/18-saturday-morning-times/" class="collection-overlay-button">View</span>
                            </a>
                </div>
                <div class="collection-item-details">
                    <span class="collection-item-text">
                      
                        <a href="https://www.google.com/fonts/specimen/Rock+Salt">Rock Salt</a>
                      
                    </span>

                    <div class="collection-item-actions">
                      <a href="/typesource/18-saturday-morning-times/" class="collection-button collection-item-action">View</a>
                    </div>
                </div>
                <!--googleon: index-->
            </div>
                ...
                <div class="collection-item-content">
                      <div contenteditable="true" spellcheck="false">
                        ...
                        <style type="text/css">
                            ...
                            <a class="collection-overlay" href="/typesource/17-nils-frahm/">
                              <span href="/typesource/17-nils-frahm/" class="collection-overlay-button">View</span>
                            </a>
                </div>
                <div class="collection-item-details">
                  <span class="collection-item-text">
                    
                      <a href="https://www.google.com/fonts/specimen/Raleway">Raleway Heavy</a> &amp; 
                  ...
                  <div class="collection-item-actions">
                    <a href="/typesource/17-nils-frahm/" class="collection-button collection-item-action">View</a>
                  </div>
                </div>
                <!--googleon: index-->
            </div>
                ...
                <div class="collection-item-content">
                    <div contenteditable="true" spellcheck="false">
                        ...
                        <style type="text/css">
                          ...
                          <a class="collection-overlay" href="/typesource/16-happiness-design/">
                            <span href="/typesource/16-happiness-design/" class="collection-overlay-button">View</span>
                          </a>
                </div>
                <div class="collection-item-details">
                  <span class="collection-item-text">
                  ...
                  <div class="collection-item-actions">
                    <a href="/typesource/16-happiness-design/" class="collection-button collection-item-action">View</a>
                  </div>
                </div>
                <!--googleon: index-->
            </div>
            ...
            <div class="collection-item">
                ...
                <div class="collection-item-content">
                        <div contenteditable="true" spellcheck="false">
                              ...
                              <a class="collection-overlay" href="/typesource/15-live-travel-adventure/">
                                <span href="/typesource/15-live-travel-adventure/" class="collection-overlay-button">View</span>
                              </a>
                </div>
                <div class="collection-item-details">
                  <span class="collection-item-text">
                    
                      <a href="https://www.google.com/fonts/specimen/Merriweather">Merriweather Light</a>
                    
                  </span>

                  <div class="collection-item-actions">
                    <a href="/typesource/15-live-travel-adventure/" class="collection-button collection-item-action">View</a>
                  </div>
                </div>
                <!--googleon: index-->
            </div>
            ...
            <div class="collection-item">
                  ...
                  <div class="collection-item-content">
                          <div contenteditable="true" spellcheck="false">
                            ...
                            <a class="collection-overlay" href="/typesource/14-please-of-finding-things-out/">
                              <span href="/typesource/14-please-of-finding-things-out/" class="collection-overlay-button">View</span>
                            </a>
                  </div>
                    <div class="collection-item-details">
                      <span class="collection-item-text">
                      ...
                      <div class="collection-item-actions">
                        <a href="/typesource/14-please-of-finding-things-out/" class="collection-button collection-item-action">View</a>
                      </div>
                    </div>
                    <!--googleon: index-->
            </div>
            ...
            <div class="collection-item">
                  ...
                  <div class="collection-item-content">
                        ...
                        <a class="collection-overlay" href="/typesource/13-get-things-done/">
                          <span href="/typesource/13-get-things-done/" class="collection-overlay-button">View</span>
                        </a>
                  </div>
                      <div class="collection-item-details">
                        <span class="collection-item-text">
                        ...
                        <div class="collection-item-actions">
                          <a href="/typesource/13-get-things-done/" class="collection-button collection-item-action">View</a>
                        </div>
                      </div>
                      <!--googleon: index-->
            </div>
            ...
            <div class="collection-item">
                    ...
                    <div class="collection-item-content">
                          <div contenteditable="true" spellcheck="false">
                            ...
                            <a class="collection-overlay" href="/typesource/12-edward-bear/">
                              <span href="/typesource/12-edward-bear/" class="collection-overlay-button">View</span>
                            </a>
                    </div>
                      <div class="collection-item-details">
                        <span class="collection-item-text">
                        ...
                        <div class="collection-item-actions">
                          <a href="/typesource/12-edward-bear/" class="collection-button collection-item-action">View</a>
                        </div>
                      </div>
                      <!--googleon: index-->
            </div>
            ...
            <div class="collection-item">
                    ...
                    <div class="collection-item-content">
                          <div contenteditable="true" spellcheck="false">
                            ...
                            <a class="collection-overlay" href="/typesource/11-sense-of-style/">
                              <span href="/typesource/11-sense-of-style/" class="collection-overlay-button">View</span>
                            </a>
                    </div>
                      <div class="collection-item-details">
                        <span class="collection-item-text">
                        ...
                        <div class="collection-item-actions">
                          <a href="/typesource/11-sense-of-style/" class="collection-button collection-item-action">View</a>
                        </div>
                      </div>
                      <!--googleon: index-->
            </div>
            ...
            <div class="collection-item">
                  ...
                  <div class="collection-item-content">
                        <div contenteditable="true" spellcheck="false">
                            ...
                            <a class="collection-overlay" href="/typesource/10-wait-until-monday/">
                              <span href="/typesource/10-wait-until-monday/" class="collection-overlay-button">View</span>
                            </a>
                  </div>
                      <div class="collection-item-details">
                        <span class="collection-item-text">
                          
                            <a href="https://www.google.com/fonts/specimen/Open+Sans+Condensed">Open Sans Condensed Bold</a> &amp; 
                          
                            <a href="https://www.google.com/fonts/specimen/Pacifico">Pacifico</a>
                          
                        </span>

                        <div class="collection-item-actions">
                          <a href="/typesource/10-wait-until-monday/" class="collection-button collection-item-action">View</a>
                        </div>
                      </div>
                      <!--googleon: index-->
            </div>
            ...
            <div class="collection-item">
                  ...
                  <div class="collection-item-content">
                          <div contenteditable="true" spellcheck="false">
                              ...
                              <a class="collection-overlay" href="/typesource/09-history-of-swedish-meatballs/">
                                <span href="/typesource/09-history-of-swedish-meatballs/" class="collection-overlay-button">View</span>
                              </a>
                  </div>
                      <div class="collection-item-details">
                        <span class="collection-item-text">
                        ...
                        <div class="collection-item-actions">
                          <a href="/typesource/09-history-of-swedish-meatballs/" class="collection-button collection-item-action">View</a>
                        </div>
                      </div>
                      <!--googleon: index-->
            </div>
            ...
            <div class="collection-item">
                  ...
                  <div class="collection-item-content">
                        <div contenteditable="true" spellcheck="false">
                            ...
                            <a class="collection-overlay" href="/typesource/08-fall-collection/">
                              <span href="/typesource/08-fall-collection/" class="collection-overlay-button">View</span>
                            </a>
                  </div>
                      <div class="collection-item-details">
                        <span class="collection-item-text">
                        ...
                        <div class="collection-item-actions">
                          <a href="/typesource/08-fall-collection/" class="collection-button collection-item-action">View</a>
                        </div>
                      </div>
                      <!--googleon: index-->
            </div>
            ...
            <div class="collection-item">
                  ...
                  <div class="collection-item-content">
                    <div contenteditable="true" spellcheck="false">
                        ...
                        <a class="collection-overlay" href="/typesource/07-shut-up-beard/">
                          <span href="/typesource/07-shut-up-beard/" class="collection-overlay-button">View</span>
                        </a>
                      </div>
                      <div class="collection-item-details">
                        <span class="collection-item-text">
                        ...
                        <div class="collection-item-actions">
                          <a href="/typesource/07-shut-up-beard/" class="collection-button collection-item-action">View</a>
                        </div>
                      </div>
                      <!--googleon: index-->
            </div>
                          ...
                          <div contenteditable="true" spellcheck="false">
                                <div class="asog">
                                    ...
                                    <style type="text/css">
                                        ...
                                        .asog-r2:before,
                                        .asog-r2:after {
                                          background: url(/img/leaves.svg) no-repeat center center/2.5em 0.7em;
                                          content: "";
                                          left: -3em;
                                          top: -0.3em;
                                          position: absolute;
                              ...
                              <a class="collection-overlay" href="/typesource/06-a-search/">
                                <span href="/typesource/06-a-search/" class="collection-overlay-button">View</span>
                              </a>
                  </div>
                      <div class="collection-item-details">
                        <span class="collection-item-text">
                          
                            <a href="https://www.google.com/fonts/specimen/PT+Sans">PT Sans Bold</a> &amp; 
                        ...
                        <div class="collection-item-actions">
                          <a href="/typesource/06-a-search/" class="collection-button collection-item-action">View</a>
                        </div>
                      </div>
                      <!--googleon: index-->
            </div>
            ...
            <div class="collection-item">
                  ...
                  <div class="collection-item-content">
                        <div contenteditable="true" spellcheck="false">
                            ...
                            <a class="collection-overlay" href="/typesource/05-perfection/">
                              <span href="/typesource/05-perfection/" class="collection-overlay-button">View</span>
                            </a>
                  </div>
                      <div class="collection-item-details">
                        <span class="collection-item-text">
                        ...
                        <div class="collection-item-actions">
                          <a href="/typesource/05-perfection/" class="collection-button collection-item-action">View</a>
                        </div>
                      </div>
                      <!--googleon: index-->
            </div>
            ...
            <div class="collection-item">
                  ...
                  <div class="collection-item-content">
                        <div contenteditable="true" spellcheck="false">
                            ...
                            <a class="collection-overlay" href="/typesource/04-how-climate-change-will-affect-you/">
                              <span href="/typesource/04-how-climate-change-will-affect-you/" class="collection-overlay-button">View</span>
                            </a>
                  </div>
                      <div class="collection-item-details">
                        <span class="collection-item-text">
                        ...
                        <div class="collection-item-actions">
                          <a href="/typesource/04-how-climate-change-will-affect-you/" class="collection-button collection-item-action">View</a>
                        </div>
                      </div>
                      <!--googleon: index-->
            </div>
            ...
            <div class="collection-item">
                  ...
                  <div class="collection-item-content">
                        ...
                        <a class="collection-overlay" href="/typesource/03-everything-you-need-to-know-about-iphone6s/">
                          <span href="/typesource/03-everything-you-need-to-know-about-iphone6s/" class="collection-overlay-button">View</span>
                        </a>
                  </div>
                      <div class="collection-item-details">
                        <span class="collection-item-text">
                            ...
                            <a href="https://www.google.com/fonts/specimen/Raleway">Raleway Thin</a>
                          
                        </span>

                        <div class="collection-item-actions">
                          <a href="/typesource/03-everything-you-need-to-know-about-iphone6s/" class="collection-button collection-item-action">View</a>
                        </div>
                      </div>
                      <!--googleon: index-->
            </div>
            ...
            <div class="collection-item">
                  ...
                  <div class="collection-item-content">
                        <div contenteditable="true" spellcheck="false">
                            ...
                            <a class="collection-overlay" href="/typesource/02-seven-days-in-tokyo/">
                              <span href="/typesource/02-seven-days-in-tokyo/" class="collection-overlay-button">View</span>
                            </a>
                  </div>
                      <div class="collection-item-details">
                        <span class="collection-item-text">
                          
                            <a href="https://www.google.com/fonts/specimen/Yanone+Kaffeesatz">Yanone Kaffeesatz ExtraLight</a>
                          
                        </span>

                        <div class="collection-item-actions">
                          <a href="/typesource/02-seven-days-in-tokyo/" class="collection-button collection-item-action">View</a>
                        </div>
                      </div>
                      <!--googleon: index-->
            </div>
                  ...
                  <div class="collection-item-content">
                          <div contenteditable="true" spellcheck="false">
                            <div class="tehc">
                              ...
                              <a class="collection-overlay" href="/typesource/01-elements-of-html-and-css/">
                                <span href="/typesource/01-elements-of-html-and-css/" class="collection-overlay-button">View</span>
                              </a>
                  </div>
                      <div class="collection-item-details">
                        <span class="collection-item-text">
                        ...
                        <div class="collection-item-actions">
                          <a href="/typesource/01-elements-of-html-and-css/" class="collection-button collection-item-action">View</a>
                        </div>
                      </div>
                      <!--googleon: index-->
            </div>
